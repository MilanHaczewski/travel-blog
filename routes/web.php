        ...
        $mapLocations = Destination::query()
            ...
            ->map(function (Destination $destination) {
                ...
                return [
                    ...
                    'title_translations' => $destination->title_translations,
                    'slug' => $destination->slug,
                    'country' => $destination->country,
                    'country_translations' => $destination->country_translations,
                    'continent' => $destination->continent,
                    'city' => $destination->city,
                    'city_translations' => $destination->city_translations,
                    ...
                    'featured_post' => $latestPost ? [
                        ...
                        'title_translations' => $latestPost->title_translations,
                        'slug' => $latestPost->slug,
                        'excerpt' => $latestPost->excerpt,
                        'excerpt_translations' => $latestPost->excerpt_translations,
